  ...
  <ul class="navbar-nav">
      ...
      <script type="text/javascript">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="worker_profile.php">Dashboard</a>
...
<form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="POST">
    ...
    <p class="text-center"> Don't Have An Account? <a href="workers_registration.php"> Register Here </a> </p>
...
if(isset($_POST['submit'])){
    ...
    $email_search = "select * from workers_info where email='$email'";
    ...
    if($email_count){
        ...
        if($password==$db_password){
            ...
            <script>
                ...
                location.replace("workerprofilefinal.php");
            </script>
            <?php
        }
        else{
